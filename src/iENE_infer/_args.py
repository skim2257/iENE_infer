...
def parser():
    ...
    parser.add_argument("--resnet", type=str, default=None, help="ResNet architecture of choice.")
    parser.add_argument("--ene_weight", type=float, default=82.65/18.44, help="Weight of ENE loss vs NM loss. For dual predictions only")
    ...
    parser.add_argument("--testaug", type=str, default=None, help="Which test time augmentation direction?")
    ...
    # Training    
    parser.add_argument("--root_directory", type=str, default=os.getenv("ROOT_PATH"), help="Directory of images.")
    parser.add_argument("--clinical_data_path", type=str, default=os.getenv("CLIN_VOL_PATH"), help="Path to clinical data file.")
    parser.add_argument("--mask_directory", type=str, default=os.getenv("MASK_PATH"), help="[OPTIONAL] Directory of masks.")
    ...
    parser.add_argument("--nnunet_model_path", type=str, default=os.getenv("NNUNET_PATH"), help="Directory of nnunet saved model")
    ...
    parser.add_argument("--wandbdir", type=str, default=os.getenv('WANDB_PATH'), help="Directory where wandb logs will be saved")
    parser.add_argument("--ckpt_path", type=str, default=os.getenv('MODEL_PATH'), help="Manually define model checkpoint file path.")
    parser.add_argument("--med3d_path", type=str, default=os.getenv("MED3D_PATH"), help="Med3d save path.")
    parser.add_argument("--ckpt_csv_path", type=str, default=os.getenv("CKPT_CSV_PATH"), help="Path to CSV of best checkpoints.")
    parser.add_argument("--version", type=int, default=0, help="model version to finetune")
    
    parser.add_argument("--test_root", type=str, default=None, help="Directory of images.")
    parser.add_argument("--test_data", type=str, default=None, help="Path to clinical data file.")
    parser.add_argument("--test_mask", type=str, default=None, help="[OPTIONAL] Directory of masks.")

    parser.add_argument("--num_workers", type=int, default=4, help="# of subprocesses.")
    parser.add_argument("--exp_name", type=str, default="rENE_final", help="Experiment name.")
